...
void drawSquare(mc::BufferBuilder* builder, mc::Vec3 pos1, mc::Vec3 pos2) {
    builder->vertex(pos1.x, pos1.y, pos1.z, true);
    builder->vertex(pos2.x, pos1.y, pos1.z, true);
    builder->vertex(pos2.x, pos2.y, pos2.z, true);
    builder->vertex(pos1.x, pos2.y, pos2.z, true);
}
...
void DisplayBox3D(mc::AABB box, int rgb, int a, bool fixCoords = false) 
{
    xf::GUI::DrawHelper::DisplayBox3D(box.min.x, box.min.y, box.min.z, box.max.x, box.max.y, box.max.z, rgb, a, true);
}
